...
def main():
    ...
    p1 = ax1_0.bar(df_weather['dato'], df_weather['temperatur_dogn'], color='red',alpha=0.4, label='Temperatur')
    ...
    p3 = ax1_1.bar(df_weather['dato'], df_weather['nedbor_dogn'], color='green', alpha=0.4, label='Nedbør (mm)')
